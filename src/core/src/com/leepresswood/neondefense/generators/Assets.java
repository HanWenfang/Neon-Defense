...
public class Assets
{
	...
	private static final String BACKGROUND_FILE_PATH = "background/";
	private static final String BACKGROUND_GRID = BACKGROUND_FILE_PATH + "grid.png";
	...
	//Background
	public Texture TEXTURE_BACKGROUND_GRID = new Texture(BACKGROUND_GRID);
	...
	{//Call this at the end of the program to clear textures from video memory.
		TEXTURE_BACKGROUND_GRID.dispose();
